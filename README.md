...
- **知识问答** — 自然语言健身问题，162 篇知识文档（90 自写 + 32 PubMed 翻译 + 40 扩展专题，557 chunks）混合检索，RRF 融合 + Re-rank 精排，带来源引用。块数取自 2026-08-30 摄入输出、与评测 manifest 同源，但**静态清单无法核验**（数据在 PostgreSQL，需重跑摄入才能复测）
