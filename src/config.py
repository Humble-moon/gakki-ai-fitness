...
# ============================================================
# Embedding（向量嵌入）模型配置
# 用于将文本（动作名、描述）转换为向量，进行语义相似度搜索
# ============================================================
EMBEDDING_MODEL = "BAAI/bge-small-zh"
# 使用的嵌入模型名称，huggingface 上的 BGE 中文小模型
# 选择原因：中文优化、体积小（约 100MB）、推理速度快

EMBEDDING_DIM = 512
# bge-small-zh 的向量维度。首次加载模型时 embedding.py 会自动检测实际维度，
# 若与配置不一致会打印警告，提醒更新此值或检查模型版本。
